            ...
            <form action="{{ route('updatePelanggan', ['id' => $pelanggan->id]) }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="kode" id="kode" class="form-control" required="required"
                        value="{{ $pelanggan->kode }}" placeholder="Masukkan Kode Pelanggan ">
                </div>

                <div class="form-group">
                    <label for="nama"> Nama Pelanggan </label>
                    <input type="text" name="nama" id="nama" class="form-control" required="required"
                        value="{{ $pelanggan->nama }}" placeholder="Masukkan nama Pelanggan ">
                </div>

                <div class="form-group">
                    <label for="alamat"> Alamat Pelanggan </label>
                    <input type="text" name="alamat" id="alamat" class="form-control" required="required"
                        value="{{ $pelanggan->alamat }}" placeholder="Masukkan Alamat Pelanggan">
                </div>
